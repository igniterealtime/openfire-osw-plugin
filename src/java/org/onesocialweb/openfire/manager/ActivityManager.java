...
public class ActivityManager {
	 ...
	 */
	public synchronized void handleMessage(String remoteJID, String localJID, ActivityEntry activity) throws AccessDeniedException {
	...
	public synchronized void handleComment(String remoteJID, String localJID, ActivityEntry commentEntry) throws UnauthorizedException, UserNotFoundException, AccessDeniedException {
